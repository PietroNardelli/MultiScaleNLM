...
*
*=========================================================================*/
#ifndef __itkGenerateScalesOutput_h
#define __itkGenerateScalesOutput_h

#include "itkComputeFeaturesFilter.h"

namespace itk
{
/**\class GenerateScalesOutput
...
public:
  ...
  typedef GenerateScalesOutput        			  Self;
  ...
  itkTypeMacro( GenerateScalesOutput, ImageToImageFilter );
  ...
  /**typedef typename SingleScaleFilterType::GradientMagnitudePixelType    GradientPixelType;
  typedef typename SingleScaleFilterType::GradientMagnitudeImageType    GradientImageType;
  ...
  virtual void SetUnaryFunctor( UnaryFunctorBaseType * arg );
...
private:
  GenerateScalesOutput(const Self&); // purposely not implemented
  ...
  /** Single scale filter */
  typename SingleScaleFilterType::Pointer m_ComputeFeaturesFilter;
...
}; // end class GenerateScalesOutput

} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkGenerateScalesOutput.hxx"
#endif
