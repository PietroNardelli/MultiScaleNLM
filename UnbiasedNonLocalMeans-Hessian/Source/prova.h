...
#include "LSDerivatives/itkLSDerivatives.h"
#include "itkImage.h"
...
public:
	...
	typedef itk::LSDerivativesL0<InputImageType, ScalesImageType>    L0Type;
	typedef typename L0Type::Pointer                                 L0Pointer;
	typedef itk::LSDerivativesL1<InputImageType, ScalesImageType, TInputImage::ImageDimension>        L1Type;
	typedef typename L1Type::Pointer                                 L1Pointer;
	typedef itk::LSDerivativesL2<InputImageType, ScalesImageType, TInputImage::ImageDimension>        L2Type;
	typedef typename L2Type::Pointer                                 L2Pointer;

	/** Hessian typedef sopport */
 	typedef itk::MultiScaleGaussianEnhancementImageFilter< InputImageType, ScalesImageType >	MultiScaleFilterType;
	typedef typename MultiScaleFilterType::Pointer				MultiScaleFilterPointer;
  	...
  	/** Supported functors. */
  	typedef itk::Functor::EigenValueFunctor<EigenValueArrayType, ScalesPixelType >	FunctorType;
	...
	itkGetMacro( NumberOfLevelSteps, unsigned int );
        void ComputeOptimalScale(void);
	void ComputeLSWeights( InputImageSizeType, unsigned int )
protected:
	NLMFilter();
	virtual ~NLMFilter();
	// Threaded filter:
