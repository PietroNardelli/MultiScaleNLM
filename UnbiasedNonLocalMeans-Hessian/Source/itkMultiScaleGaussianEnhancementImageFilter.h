...
public:
  ...
  typedef typename SingleScaleFilterType::GradientFilterType   		GradientFilterType;
  ...
  typedef typename HessianTensorImageType::PixelType  			HessianPixelType;
  ...
  *  each pixel for the best vesselness response */
  ...
  /** Get the image containing the gaussian image at which each pixel gave the best response */
  const GaussianImageType * GetGaussianOutput( void ) const;

  /** Get the image containing the gradient image at which each pixel gave the best response */
  const GradientImageType * GetGradientOutput( void ) const;

  /** Get the image containing the hessian image at which each pixel gave the best response */
  const HessianTensorImageType * GetHessianOutput( void ) const;
