...
namespace itk
{
	...
	typedef std::map< double, float* >  TFilterValuesMap;
	typedef std::pair< double, float* > TFilterValuesPair;
...
public:
	...
	typedef TScalesImage				    InputScalesImageType;
	typedef typename InputScalesImageType::Pointer      InputScalesImagePointer;
	typedef typename InputScalesImageType::ConstPointer      InputScalesImageConstPointer;
	...
	itkSetMacro( MinimumLevel, float );
	itkGetMacro( MinimumLevel, float );
	itkSetMacro( MaximumLevel, float );
	itkGetMacro( MaximumLevel, float );
	itkSetMacro( NumberOfLevels, unsigned int );
	itkGetMacro( NumberOfLevels, unsigned int );

	void SetScalesImage( InputScalesImageConstPointer image );
...
private:
	...
	unsigned int m_NumberOfLevels;
        InputScalesImageConstPointer m_scalesImage;
};
